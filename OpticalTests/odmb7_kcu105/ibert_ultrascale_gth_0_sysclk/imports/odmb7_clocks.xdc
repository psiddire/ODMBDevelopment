...
create_clock -name gp_clk_6 -period 12.5  [get_ports gth_sysclkp_i]
...
create_clock -name gth_refclk0_q226 -period 6.25 [get_ports gth_refclk0p_i[0]]
create_clock -name gth_refclk1_q226 -period 8    [get_ports gth_refclk1p_i[0]]
